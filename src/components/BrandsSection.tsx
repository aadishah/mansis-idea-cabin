...
const brands: Brand[] = [
  ...
  { id: 2, name: "Flipkart Minutes", logo: flipkartMinutesLogo, scale: "scale-150" },
  ...
  { id: 8, name: "Dream11", logo: dream11Logo, scale: "scale-150" },
  { id: 9, name: "Lenovo", logo: lenovoLogo },
  { id: 10, name: "Diataal", logo: diataalLogo, scale: "scale-150" },
  { id: 11, name: "CEAT", logo: ceatLogo },
  { id: 12, name: "HDFC Bank", logo: hdfcLogo, scale: "scale-[1.75]" },
