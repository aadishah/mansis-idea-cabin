        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-lg text-muted-foreground leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              <p>
                Over the years, I've worked with three agencies on a diverse range of brands, 
                learning that the best ideas come from curiosity, culture, and a 
                relentless drive to break things open.
              </p>
              <p>
                Beyond client work, I pour energy into personal projects—passion briefs, 
            ...
            <div className="space-y-6">
              {funFacts.map((fact, index) => (
                ...
                >
                  ...
                  <p className="text-foreground pt-2 flex-1">
                    {fact.text}
                  </p>
                </div>
              ))}
