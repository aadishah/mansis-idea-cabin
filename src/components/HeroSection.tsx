    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold text-white mb-8 leading-tight animate-fade-in-up">
          ...
          <br />
          <span className="inline-block text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            I write ideas that move people.
          </span>
        </h1>
        
        <p className="text-xl md:text-2xl text-white/95 mb-6 font-medium animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
          Creative Writer & Ad Ideator at FCB Kinnect Digital
        </p>
        
        <p className="text-lg md:text-xl text-white/90 mb-14 max-w-2xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.7s' }}>
